...
getLogos :: Picture -> Picture -> (Picture, Picture)
getLogos l1 l2 = (l1', l2')
  where
    l1' = translate (-420) 435 l1
    l2' = translate 445 440 l2

getTitle :: Picture -> Picture
getTitle l1 = l1'
  where
    l1' = translate (-0) 440 l1
...
render [bg, sonny, celestin, menuPic, keys, redBike, blueBike, l1, l2, title] game = case gameState game of
  Playing
  ...
  where
    ...
    (l1', l2') = getLogos l1 l2
    (outline, blackbg) = getBg
    (score1, score2) = getScore game
    (sonny', celestin') = getTek2 sonny celestin
    title' = getTitle title
    drawPictures extraPics = pictures ([bg, sonny', celestin', blackbg, outline, score1, score2, l1', l2', title'] ++ extraPics)
